...
[PASS] test_stake() (gas: 790107)
Traces:
  [794320] RNTTokenStakePool_Test::test_stake()
    ...
    ├─ [658] RNTToken::getDigest(0xc3349c38c41894a84ecb63e60f6a8815661f2bc050ab143c72b5ca08c56e257d) [staticcall]
    ...
    │   └─ ← [Return] 
    ├─ [148932] RNTTokenStakePool::stake(ERC20PermitData({ value: 1000000000000000000 [1e18], deadline: 601, v: 27, r: 0xda8e32f4be8173d670d7a06c559ffb6192b6a977c713c850ae0dd0673d7f2d97, s: 0x5cab353c76dc0662da3352f2154928359be64a61bcd57ea11b5cd24036680cdd }))
    │   ├─ [51463] RNTToken::permit(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], RNTTokenStakePool: [0x8B111e359886e000940d6850d77d1dE966C55651], 1000000000000000000 [1e18], 601, 27, 0xda8e32f4be8173d670d7a06c559ffb6192b6a977c713c850ae0dd0673d7f2d97, 0x5cab353c76dc0662da3352f2154928359be64a61bcd57ea11b5cd24036680cdd)
    ...
    │   │   └─ ← [Stop] 
    │   ├─ [8967] RNTToken::transferFrom(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], RNTTokenStakePool: [0x8B111e359886e000940d6850d77d1dE966C55651], 1000000000000000000 [1e18])
    ...
    ├─ [652] RNTToken::balanceOf(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb]) [staticcall]
    │   └─ ← [Return] 0
    ├─ [328] RNTTokenStakePool::TOTAL_STAKE_REWARD() [staticcall]
    ...
    ├─ [307] RNTTokenStakePool::currentStakeAmount() [staticcall]
    │   └─ ← [Return] 1000000000000000000 [1e18]
    ├─ [0] VM::warp(86401 [8.64e4])
    │   └─ ← [Return] 
    ├─ [0] VM::prank(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb])
    │   └─ ← [Return] 
    ├─ [218153] RNTTokenStakePool::claim()
    │   ├─ [25167] RNTToken::transfer(esRNTToken: [0xe7081320a577e7a7E05E76C5675A01efA03cFfD0], 1000000000000000000 [1e18])
    ...
    ├─ [652] RNTToken::balanceOf(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb]) [staticcall]
    │   └─ ← [Return] 1000000000000000000 [1e18]
    ├─ [658] RNTToken::getDigest(0x2bf1259092820f735c559a38c3b7c71c1dec95573e37ddca781653a60f1a8277) [staticcall]
    ...
    │   │   ├─ emit Approval(owner: staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], spender: RNTTokenStakePool: [0x8B111e359886e000940d6850d77d1dE966C55651], value: 1000000000000000000 [1e18])
    │   │   └─ ← [Stop] 
    │   ├─ [6967] RNTToken::transferFrom(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], RNTTokenStakePool: [0x8B111e359886e000940d6850d77d1dE966C55651], 1000000000000000000 [1e18])
    │   │   ├─ emit Transfer(from: staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], to: RNTTokenStakePool: [0x8B111e359886e000940d6850d77d1dE966C55651], value: 1000000000000000000 [1e18])
    │   │   └─ ← [Return] true
    │   └─ ← [Stop] 
    ├─ [652] RNTToken::balanceOf(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb]) [staticcall]
    │   └─ ← [Return] 0
    ├─ [308] RNTTokenStakePool::already_claimed_Rewards() [staticcall]
    │   └─ ← [Return] 1000000000000000000 [1e18]
    ├─ [307] RNTTokenStakePool::currentStakeAmount() [staticcall]
    ...
    ├─ [0] VM::prank(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb])
    │   └─ ← [Return] 
    ├─ [77453] RNTTokenStakePool::claim()
    │   ├─ [3267] RNTToken::transfer(esRNTToken: [0xe7081320a577e7a7E05E76C5675A01efA03cFfD0], 2000000000000000000 [2e18])
    ...
    ├─ [0] VM::prank(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb])
    │   └─ ← [Return] 
    ├─ [27475] RNTTokenStakePool::unstake(2000000000000000000 [2e18])
    │   ├─ [23167] RNTToken::transfer(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], 2000000000000000000 [2e18])
    ...
    ├─ [0] VM::prank(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb])
    │   └─ ← [Return] 
    ├─ [38641] esRNTToken::burn(0)
    │   ├─ [3267] RNTToken::transfer(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], 500000000000000000 [5e17])
    ...
    │   │   └─ ← [Return] true
    │   ├─ emit Transfer(from: staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], to: 0x0000000000000000000000000000000000000000, value: 500000000000000000 [5e17])
    │   ├─ [25167] RNTToken::transfer(RNTToken: [0xfF2A21441C4755bAa7bBE9fDB9422fcaAFAFF70f], 500000000000000000 [5e17])
    │   │   ├─ emit Transfer(from: esRNTToken: [0xe7081320a577e7a7E05E76C5675A01efA03cFfD0], to: RNTToken: [0xfF2A21441C4755bAa7bBE9fDB9422fcaAFAFF70f], value: 500000000000000000 [5e17])
    │   │   └─ ← [Return] true
    │   └─ ← [Stop] 
    ├─ [652] RNTToken::balanceOf(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb]) [staticcall]
    ...
    ├─ [0] VM::prank(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb])
    │   └─ ← [Return] 
    ├─ [12741] esRNTToken::burn(1)
    │   ├─ [3267] RNTToken::transfer(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], 2000000000000000000 [2e18])
    ...
    │   │   └─ ← [Return] true
    │   ├─ emit Transfer(from: staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb], to: 0x0000000000000000000000000000000000000000, value: 0)
    │   ├─ [3267] RNTToken::transfer(RNTToken: [0xfF2A21441C4755bAa7bBE9fDB9422fcaAFAFF70f], 0)
    │   │   ├─ emit Transfer(from: esRNTToken: [0xe7081320a577e7a7E05E76C5675A01efA03cFfD0], to: RNTToken: [0xfF2A21441C4755bAa7bBE9fDB9422fcaAFAFF70f], value: 0)
    │   │   └─ ← [Return] true
    │   └─ ← [Stop] 
    ├─ [652] RNTToken::balanceOf(staker: [0x8eDc168c9bBB5ed126960E4a9F99b6c96EC76BEb]) [staticcall]
...
Suite result: ok. 1 passed; 0 failed; 0 skipped; finished in 4.16ms (2.17ms CPU time)

Ran 1 test suite in 614.13ms (4.16ms CPU time): 1 tests passed, 0 failed, 0 skipped (1 total tests)
