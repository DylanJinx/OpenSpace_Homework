...
Ran 1 test for test/TokenFactory_v1_Test.sol:TokenFactory_v1_Test
[PASS] test_factory_v1() (gas: 1548622)
Logs:
...
Traces:
  [1868754] TokenFactory_v1_Test::setUp()
  ...
  [1548622] TokenFactory_v1_Test::test_factory_v1()
...
Suite result: ok. 1 passed; 0 failed; 0 skipped; finished in 16.51ms (2.10ms CPU time)

Ran 1 test for test/TokenFactory_v1_upgrade_v2_Test.sol:TokenFactory_v1_Test
...
Traces:
  [1886164] TokenFactory_v1_Test::setUp()
    ├─ [0] VM::addr(<pk>) [staticcall]
    │   └─ ← [Return] tokenCreator_1: [0xC66CCFbcE7Fc39E1bC7c512637D06a9AF1Fd5602]
    ├─ [0] VM::label(tokenCreator_1: [0xC66CCFbcE7Fc39E1bC7c512637D06a9AF1Fd5602], "tokenCreator_1")
    │   └─ ← [Return] 
  ...
  [3802763] TokenFactory_v1_Test::test_factory_v1_upgrade_v2()
    ├─ [0] VM::prank(tokenCreator_1: [0xC66CCFbcE7Fc39E1bC7c512637D06a9AF1Fd5602])
    │   └─ ← [Return] 
    ├─ [689176] ERC1967Proxy::deployInscription("token_1", 10000 [1e4], 1000)
    │   ├─ [684262] TokenFactory_v1::deployInscription("token_1", 10000 [1e4], 1000) [delegatecall]
...
Suite result: ok. 1 passed; 0 failed; 0 skipped; finished in 17.24ms (2.84ms CPU time)

Ran 2 test suites in 307.42s (33.75ms CPU time): 2 tests passed, 0 failed, 0 skipped (2 total tests)
