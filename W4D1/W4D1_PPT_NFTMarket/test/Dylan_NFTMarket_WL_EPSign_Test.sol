...
contract Dylan_NFTMarket_WL_EPSign_Test is Test {
    ...
    function test_Success_Two_WLSign_ERC20Permit() public {
    ...
    function test_Fail_Two_WLSign_ERC20Permit() public {
        // This NFT requires whitelist purchase
        uint256 tokenId_= nftSellerListNFT(true);
        bytes32 orderHashId_ = marketContract.isListed(address(nftContract), tokenId_);
        // give the nftBuyer some tokens
    ...
    // need handling fee
    function test_Success_Two_WLSign_ERC20Permit_fee() public {
        // This NFT requires whitelist purchase
        uint256 tokenId_= nftSellerListNFT(true);
        bytes32 orderHashId_ = marketContract.isListed(address(nftContract), tokenId_);
        // give the nftBuyer some tokens
