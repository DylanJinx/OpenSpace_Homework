...
Suite result: ok. 3 passed; 0 failed; 0 skipped; finished in 4.65ms (3.11ms CPU time)

Ran 1 test suite in 2.55s (4.65ms CPU time): 3 tests passed, 0 failed, 0 skipped (3 total tests)
