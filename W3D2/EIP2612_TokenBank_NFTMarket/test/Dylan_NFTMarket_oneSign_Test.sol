...
contract Dylan_NFTMarket_oneSign_Test is Test {
    ...
    function test_SuccessBuyNFT_WLSign() public {
    ...
    function test_FailBuyNFT_WLSign() public {
        // This NFT requires whitelist purchase
        uint256 tokenId_= nftSellerListNFT(true);
        bytes32 orderHashId_ = marketContract.isListed(address(nftContract), tokenId_);
        // give the nftBuyer some tokens
    ...
    // need handling fee
    function test_SuccessBuyNFT_WLSign_fee() public {
        // This NFT requires whitelist purchase
        uint256 tokenId_= nftSellerListNFT(true);
        bytes32 orderHashId_ = marketContract.isListed(address(nftContract), tokenId_);
        // give the nftBuyer some tokens
